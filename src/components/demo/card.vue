		...
		<ul class="list" ref="listWrapper">
			...
			<li class="item dif-item">
				...
				<div class="ratio-other">
					...
					<input type="text" class="voteother" maxlength="5" :disabled="isEditable">
				</div>
			</li>
			...
			<li class="item dif-item">
				...
				<div class="ratio-other">
					...
					<input type="radio" @click="changeAgree(agreeArr[agreeArr.length-1],agreeArr.length-1)" :checked="agreeArr[agreeArr.length-1]"
					 :ref="refsArr[refsArr.length-1]" :id="refsArr[refsArr.length-1] +data.position_id+'-33'" :name="'val1-'+data.position_id" />
		...
		methods: {
			...
			changeAgreeDif(isckecked, index) {
				...
				if (this.$refs[this.refsArr[index]].checked) {
					...
					/* var checkedArr = itemArr[0].getElementsByClassName("radio-item")[1].getElementsByTagName('input')[0].checked
					console.log(checkedArr)
					itemArr[0].getElementsByClassName("radio-item")[1].getElementsByTagName('input')[0].checked = true;
					console.log(checkedArr) */
					// console.log(loopNum)
			...
			unCkecked(){
				// var inpObj = document.getElementsByClassName("dif-item")[1].getElementsByTagName('input')[0];
				document.getElementsByClassName("dif-item")[1].getElementsByTagName('input')[0].checked = false;
			}
		},
		created() {
			this.initArr()
